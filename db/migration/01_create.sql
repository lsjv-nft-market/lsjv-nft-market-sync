create table lsjv_activity_sepolia
(
...
create table lsjv_collection_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
...
create index index_collection_token_type
    on lsjv_activity_sepolia (collection_address, token_id, activity_type);

create index index_hash_collection_token_type
    on lsjv_activity_sepolia (tx_hash, collection_address, token_id, activity_type);

create index index_tx_collection_token_type_time
    on lsjv_activity_sepolia (tx_hash, collection_address, token_id, activity_type, event_time);

create table lsjv_collection_floor_price_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
...
create table lsjv_collection_import_record_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
...
create table lsjv_lobal_collection_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
    collection_address varchar(42)       not null,
...
create table lsjv_item_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
...
create index index_collection_item_name
    on lsjv_item_sepolia (collection_address, token_id, name);

create index index_collection_owner
    on lsjv_item_sepolia (collection_address, owner);

create index index_collection_token_owner
    on lsjv_item_sepolia (collection_address, token_id, owner);

create index index_owner
    on lsjv_item_sepolia (owner);

create table lsjv_item_external_sepolia
(
    id                  bigint auto_increment comment '主键'
        primary key,
    collection_address  varchar(42)             not null,
...
create table lsjv_item_trait_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
...
create index index_collection_token
    on lsjv_item_trait_sepolia (collection_address, token_id);

create index index_collection_trait_value
    on lsjv_item_trait_sepolia (collection_address, trait, trait_value);

create index index_trait_value
    on lsjv_item_trait_sepolia (trait, trait_value);

create table lsjv_order_sepolia
(
    id                 bigint auto_increment comment '主键'
        primary key,
...
create index index_collection_maker_status_type_market_token_id
    on lsjv_order_sepolia (collection_address, maker, order_status, order_type, marketplace_id, token_id);

create index index_collection_token
    on lsjv_order_sepolia (collection_address, token_id);

create table lsjv_user
(
    id          bigint auto_increment comment '主键'
        primary key,
...
create table lsjv_indexed_status
(
    id                 bigint auto_increment comment '主键'
        primary key,
